...
void raylib::script_extend(lua_State* L)
{
	...
	.beginNamespace("raylib")
		...
		*/
		...
		.addFunction("funcNameHere", CheckCollisionSpheres)
		.addFunction("funcNameHere", CheckCollisionBoxes)
		.addFunction("funcNameHere", CheckCollisionBoxSphere)
		.addFunction("funcNameHere", GetRayCollisionSphere)
		.addFunction("funcNameHere", GetRayCollisionBox)
		.addFunction("funcNameHere", GetRayCollisionMesh)
		.addFunction("funcNameHere", GetRayCollisionTriangle)
		.addFunction("funcNameHere", GetRayCollisionQuad)
	.endNamespace();
}
